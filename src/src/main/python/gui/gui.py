...
class GUI:
    ...
    def __init__(self, alg=None):
        ...
        appctxt = ApplicationContext() #PAUL CHANGED THIS ON 21/6 @ 2:33
        #app = QApplication([]) #PAUL CHANGED THIS ON 21/6 @ 2:33
        window = Window()
        self.form = Form()
        self.form.setupUi(window)
        window.show()
        self.setup_buttons()
        appctxt.app.exec_() #PAUL CHANGED THIS ON 21/6 @ 2:34
        #app.exec_() #PAUL CHANGED THIS ON 21/6 @ 2:34
    ...
    def generate(self, alg, excel_file_path='./InputOutput/Sample.xlsx', outputDir='./InputOutput/'):
        ...
        algorithms = [ILP(excel_file_path), Greedy(excel_file_path), Tabu(excel_file_path), Random(excel_file_path), Weekly(excel_file_path), Genetic(excel_file_path), Weekly_Tabu(excel_file_path)]
